...
.method public authenticate(Lorg/apache/http/auth/Credentials;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/Header;
    ...
    .line 152
    const-string p1, "1.2.840.113554.1.2.2"
    ...
    sget-object v4, Lorg/apache/http/impl/auth/NegotiateScheme$State;->CHALLENGE_RECEIVED:Lorg/apache/http/impl/auth/NegotiateScheme$State;
    ...
    invoke-interface {p3, v3}, Lorg/apache/commons/logging/Log;->debug(Ljava/lang/Object;)V
    ...
    invoke-direct {p3, v3}, Lorg/ietf/jgss/Oid;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v6, v3}, Lorg/ietf/jgss/GSSManager;->createName(Ljava/lang/String;Lorg/ietf/jgss/Oid;)Lorg/ietf/jgss/GSSName;

    move-result-object v6

    .line 202
    iget-object v7, p0, Lorg/apache/http/impl/auth/NegotiateScheme;->negotiationOid:Lorg/ietf/jgss/Oid;

    invoke-interface {v6, v7}, Lorg/ietf/jgss/GSSName;->canonicalize(Lorg/ietf/jgss/Oid;)Lorg/ietf/jgss/GSSName;

    move-result-object v6

    iget-object v7, p0, Lorg/apache/http/impl/auth/NegotiateScheme;->negotiationOid:Lorg/ietf/jgss/Oid;

    invoke-virtual {v5, v6, v7, v3, v4}, Lorg/ietf/jgss/GSSManager;->createContext(Lorg/ietf/jgss/GSSName;Lorg/ietf/jgss/Oid;Lorg/ietf/jgss/GSSCredential;I)Lorg/ietf/jgss/GSSContext;
    ...
    .line 205
    invoke-interface {v5, p3}, Lorg/ietf/jgss/GSSContext;->requestMutualAuth(Z)V

    .line 206
    iget-object v5, p0, Lorg/apache/http/impl/auth/NegotiateScheme;->gssContext:Lorg/ietf/jgss/GSSContext;

    invoke-interface {v5, p3}, Lorg/ietf/jgss/GSSContext;->requestCredDeleg(Z)V
    :try_end_1
    ...
    .line 210
    :try_start_2
    invoke-virtual {v5}, Lorg/ietf/jgss/GSSException;->getMajor()I
    ...
    const-string v6, "GSSException BAD_MECH, retry with Kerberos MECH"
    ...
    invoke-direct {v5, p1}, Lorg/ietf/jgss/Oid;-><init>(Ljava/lang/String;)V

    iput-object v5, p0, Lorg/apache/http/impl/auth/NegotiateScheme;->negotiationOid:Lorg/ietf/jgss/Oid;
    ...
    invoke-virtual {v5, p2, v3}, Lorg/ietf/jgss/GSSManager;->createName(Ljava/lang/String;Lorg/ietf/jgss/Oid;)Lorg/ietf/jgss/GSSName;
    ...
    invoke-interface {p2, v2}, Lorg/ietf/jgss/GSSName;->canonicalize(Lorg/ietf/jgss/Oid;)Lorg/ietf/jgss/GSSName;

    move-result-object p2

    iget-object v2, p0, Lorg/apache/http/impl/auth/NegotiateScheme;->negotiationOid:Lorg/ietf/jgss/Oid;

    invoke-virtual {v5, p2, v2, v3, v4}, Lorg/ietf/jgss/GSSManager;->createContext(Lorg/ietf/jgss/GSSName;Lorg/ietf/jgss/Oid;Lorg/ietf/jgss/GSSCredential;I)Lorg/ietf/jgss/GSSContext;
    ...
    invoke-interface {p2, p3, v4, v2}, Lorg/ietf/jgss/GSSContext;->initSecContext([BII)[B
    ...
    invoke-static {p2, v4}, Lorg/apache/commons/codec/binary/Base64;->encodeBase64([BZ)[B
    ...
    const-string v1, "\' back to the auth server"
