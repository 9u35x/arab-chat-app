...
.method public constructor <init>(Lcom/google/android/gms/cast/framework/CastContext;Landroidx/media3/cast/MediaItemConverter;JJ)V
    ...
    new-instance v0, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda13;

    invoke-direct {v0, p0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda13;-><init>(Landroidx/media3/cast/CastPlayer;)V

    invoke-direct {p4, p5, p6, v0}, Landroidx/media3/common/util/ListenerSet;-><init>(Landroid/os/Looper;Landroidx/media3/common/util/Clock;Landroidx/media3/common/util/ListenerSet$IterationFinishedEvent;)V
...
.method private setPlaybackParametersAndNotifyIfChanged(Landroidx/media3/common/PlaybackParameters;)V
    ...
    new-instance v1, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda0;

    invoke-direct {v1, p1}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda0;-><init>(Landroidx/media3/common/PlaybackParameters;)V
...
.method private setPlayerStateAndNotifyIfChanged(ZII)V
    ...
    new-instance v7, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda5;

    invoke-direct {v7, p1, p3}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda5;-><init>(ZI)V
    ...
    new-instance v6, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda6;

    invoke-direct {v6, p3}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda6;-><init>(I)V
    ...
    new-instance v5, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda7;

    invoke-direct {v5, p1, p2}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda7;-><init>(ZI)V
    ...
    new-instance p2, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda8;

    invoke-direct {p2, v1}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda8;-><init>(Z)V
...
.method private setRepeatModeAndNotifyIfChanged(I)V
    ...
    new-instance v1, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda17;

    invoke-direct {v1, p1}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda17;-><init>(I)V
...
.method private updateAvailableCommandsAndNotifyIfChanged()V
    ...
    new-instance v1, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda12;

    invoke-direct {v1, p0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda12;-><init>(Landroidx/media3/cast/CastPlayer;)V
...
.method private updateInternalStateAndNotifyIfChanged()V
    ...
    new-instance v6, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda1;

    invoke-direct {v6, v1, v3}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda1;-><init>(Landroidx/media3/common/Player$PositionInfo;Landroidx/media3/common/Player$PositionInfo;)V
    ...
    new-instance v3, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda2;

    invoke-direct {v3, v0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda2;-><init>(Landroidx/media3/cast/CastPlayer;)V
    ...
    new-instance v3, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda3;

    invoke-direct {v3, v0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda3;-><init>(Landroidx/media3/cast/CastPlayer;)V
    ...
    new-instance v2, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda4;

    invoke-direct {v2, v0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda4;-><init>(Landroidx/media3/cast/CastPlayer;)V
...
.method private updateTimeline()Z
    ...
    invoke-static {v0, v2}, Landroidx/media3/cast/CastPlayer;->fetchCurrentWindowIndex(Lcom/google/android/gms/cast/framework/media/RemoteMediaClient;Landroidx/media3/common/Timeline;)I

    move-result v0

    iput v0, p0, Landroidx/media3/cast/CastPlayer;->currentWindowIndex:I
...
.method private updateTimelineAndNotifyIfChanged()Z
    ...
    new-instance v6, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda9;

    invoke-direct {v6, v3}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda9;-><init>(Landroidx/media3/common/Timeline;)V
    ...
    new-instance v9, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda10;

    invoke-direct {v9, v7, v2}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda10;-><init>(Landroidx/media3/common/Player$PositionInfo;Landroidx/media3/common/Player$PositionInfo;)V
    ...
    new-instance v2, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda11;

    invoke-direct {v2, v0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda11;-><init>(Landroidx/media3/cast/CastPlayer;)V
...
.method private updateTracksAndSelectionsAndNotifyIfChanged()Z
    ...
    invoke-static {v9, v10, v0}, Landroidx/media3/cast/CastPlayer;->isTrackActive(J[J)Z
...
.method public seekTo(IJIZ)V
    ...
    new-instance v0, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda14;

    invoke-direct {v0, p5, p2}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda14;-><init>(Landroidx/media3/common/Player$PositionInfo;Landroidx/media3/common/Player$PositionInfo;)V
    ...
    new-instance p3, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda15;

    invoke-direct {p3, p1}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda15;-><init>(Landroidx/media3/common/MediaItem;)V
    ...
    new-instance p2, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda16;

    invoke-direct {p2, p0}, Landroidx/media3/cast/CastPlayer$$ExternalSyntheticLambda16;-><init>(Landroidx/media3/cast/CastPlayer;)V
