.class public La3945963/cti/s_cargar_icos_gen;
...
.method protected onHandleIntent(Landroid/content/Intent;)V
    ...
    .line 28
    invoke-virtual {p0}, La3945963/cti/s_cargar_icos_gen;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    check-cast v0, La3945963/cti/config;

    iput-object v0, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;
    ...
    const-string v4, "3945963_ico_perfil.png?v="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;

    iget v4, v4, La3945963/cti/config;->v_ico_perfil:I
    ...
    const-string v4, "3945963_ico_privados.png?v="
    ...
    const-string v4, "3945963_ico_foto.png?v="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;

    iget v4, v4, La3945963/cti/config;->v_ico_foto:I
    ...
    const-string v4, "3945963_ico_video.png?v="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;

    iget v4, v4, La3945963/cti/config;->v_ico_video:I
    ...
    const-string v4, "3945963_ico_emotic.png?v="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;

    iget v4, v4, La3945963/cti/config;->v_ico_emotic:I
    ...
    const-string v4, "3945963_ico_enviar.png?v="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v4, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;

    iget v4, v4, La3945963/cti/config;->v_ico_enviar:I
    ...
    iput-object v2, p0, La3945963/cti/s_cargar_icos_gen;->bm:Landroid/graphics/Bitmap;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1

    .line 110
    :try_start_2
    invoke-virtual {p0, v5, v0}, La3945963/cti/s_cargar_icos_gen;->openFileOutput(Ljava/lang/String;I)Ljava/io/FileOutputStream;

    move-result-object v2

    .line 111
    iget-object v5, p0, La3945963/cti/s_cargar_icos_gen;->bm:Landroid/graphics/Bitmap;
    ...
    .line 123
    :goto_3
    iget-object v2, p0, La3945963/cti/s_cargar_icos_gen;->globales:La3945963/cti/config;
    ...
    invoke-virtual {p0, v2, v0}, La3945963/cti/s_cargar_icos_gen;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
