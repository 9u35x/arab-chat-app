.class public La3945963/cti/bd_provider;
.super Landroid/content/ContentProvider;
.source "bd_provider.java"


# static fields
.field private static final AUTHORITY:Ljava/lang/String; = "a3945963.cti.bd_provider"
...
# instance fields
.field private mDB:La3945963/cti/bd;
...
.method static constructor <clinit>()V
    ...
    .line 31
    const-string v0, "content://a3945963.cti.bd_provider/productos"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, La3945963/cti/bd_provider;->PRODUCTOS_URI:Landroid/net/Uri;

    .line 34
    const-string v0, "content://a3945963.cti.bd_provider/fotos"

    invoke-static {v0}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    sput-object v0, La3945963/cti/bd_provider;->FOTOS_URI:Landroid/net/Uri;
    ...
    sput-object v0, La3945963/cti/bd_provider;->sURIMatcher:Landroid/content/UriMatcher;
    ...
    const-string v3, "a3945963.cti.bd_provider"
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 105
    sget-object v0, La3945963/cti/bd_provider;->sURIMatcher:Landroid/content/UriMatcher;
    ...
    .line 107
    :try_start_0
    iget-object v1, p0, La3945963/cti/bd_provider;->mDB:La3945963/cti/bd;

    invoke-virtual {v1}, La3945963/cti/bd;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 175
    :goto_0
    invoke-virtual {p0}, La3945963/cti/bd_provider;->getContext()Landroid/content/Context;
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    .line 206
    sget-object v1, La3945963/cti/bd_provider;->sURIMatcher:Landroid/content/UriMatcher;
    ...
    .line 217
    :try_start_0
    iget-object v3, p0, La3945963/cti/bd_provider;->mDB:La3945963/cti/bd;
...
.method public onCreate()Z
    ...
    .line 68
    new-instance v0, La3945963/cti/bd;

    invoke-virtual {p0}, La3945963/cti/bd_provider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, La3945963/cti/bd;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, La3945963/cti/bd_provider;->mDB:La3945963/cti/bd;
